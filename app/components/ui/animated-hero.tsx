...
export const AnimatedHero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* AetherHero shader background */}
      <div className="absolute inset-0">
        <AetherHero
          title=""
          subtitle=""
          height="100%"
          overlayGradient="linear-gradient(180deg, #000000dd 0%, #00000099 40%, #00000066 70%, transparent)"
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 pt-20">
        <div className="max-w-6xl w-full text-center">
          ...
          <motion.p
            ...
            className="mt-12 text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed"
          >
